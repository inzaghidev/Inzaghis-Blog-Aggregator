...
export function ArticleCard({
  ...
  return (
    <article className="group paper overflow-hidden rounded-2xl transition duration-300 hover:-translate-y-1 hover:shadow-lg">
      <Link href={article.url} className="block">
        <div className={compact ? "relative h-34" : "relative h-48"}>
          <Image
            src={article.cover}
            alt=""
            fill
        ...
        <div className="p-5">
          <p className="mb-2 text-[10px] font-bold uppercase tracking-wide text-orange-500">
            {article.labels[0]}{" "}
